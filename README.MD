...
#extra-keys = [[{key:ESC,display:'E'},'#','~','^','$','@','&','%','*','=','-','+','QUOTE','APOSTROPHE','`','_',{macro:"ESC :bn ENTER",display:'N'},{key:HOME,display:'H'},{key:END,display:'E'},'UP'],['TAB','!','|','BACKSLASH','/','(',')','{','}','[',']','<','>',':',';',{key:CTRL,display:'C'},{macro:"ESC :w ENTER",display:'S'},'LEFT','DOWN','RIGHT']]
